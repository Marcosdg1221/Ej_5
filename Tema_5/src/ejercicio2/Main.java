...
public class Main {
	public static void main(String[] args) {
		...
		double cartasacáh = 0;
		String respuesta = "si";
		double puntosJ1 = 0, puntosJ2 = 0;
		cartas = SieteYMedia.Valorcartas(cartas); // Establece los puntos de las cartas
		while (puntosJ1 < 8 & respuesta.equals("si")) { // Mientras J1 no se pase y siga diciendo sí, seguirá sacando
														// cartas hasta pasarse o no decir si.
		...
		} while (puntosJ2 < 8 & respuesta.equals("si")); //Hago un do while debido a que el j2 sacará al menos una carta cuando le toque el turno

		if (puntosJ1 > puntosJ2 & puntosJ1 < 8) { //Comprueba si ganó J1; si su puntuación es mayor que el j2 y es menor de 8.
			if (puntosJ1 < 8) {
